...
const deleteChipById = `-- name: DeleteChipById :exec
DELETE FROM chirps
WHERE id = $1
`

func (q *Queries) DeleteChipById(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, deleteChipById, id)
	return err
}
...
func (q *Queries) GetAllUserChirps(ctx context.Context, userID uuid.UUID) ([]Chirp, error) {
